...
# Test pinned-versions installation - all tools with specific versions
...
# Test ripgrep (neovim supporting tool)
...
# Test fd (neovim supporting tool)
...
# Test fzf (neovim supporting tool)
